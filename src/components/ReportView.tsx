...
import {
  Database, FileText, Loader2, CheckCircle2, AlertCircle, X, Maximize2,
  Printer, Pencil, Trash2, RotateCcw, Check,
} from 'lucide-react';
import type { Order } from '../types';
import { ToolcribLibraryPanel } from './ToolcribLibraryPanel';
import { getOrderAgeDays, formatAgeDays } from '../lib/age';
import type { useVisionAnalysis } from '../hooks/useVisionAnalysis';
...
export function StepLabel({ n, label, done = false }: { n: string; label: string; done?: boolean }): ReactElement {
  return (
...
export interface ReportViewProps {
  vision: ReturnType<typeof useVisionAnalysis>;
  summary: DashboardSummary;
}

export function ReportView({ vision, summary }: ReportViewProps): ReactElement {
  useEffect(() => {
